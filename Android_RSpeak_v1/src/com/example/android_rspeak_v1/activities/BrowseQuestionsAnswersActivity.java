...
public class BrowseQuestionsAnswersActivity extends ActionBarActivity implements ActionBar.TabListener 
{
    ...
    public void onResume()
    {
    	...
    	GetCreditScoreTransaction getCreditScoreTransaction = new GetCreditScoreTransaction( this );
    	getCreditScoreTransaction.beginTransaction();
    	...
    	if ( credit_points != -1 )
    	{
    		...
    		credit.setText( "Credit Score: " + credit_points );
    	}
    }
